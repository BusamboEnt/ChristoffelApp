...
const MenuScreen: React.FC = () => {
  ...
  const menuItems: MenuItem[] = [
    ...
    { 
      ...
      price: 145.00,
      image: require('../assets/Crispy Calamari with Aioli.jpg'),
      category: 'À la carte',
      course: 'starter',
      dietary: ['Dairy-free'],
    ...
    { 
      ...
      price: 95.00,
      image: require('../assets/Soup of the Day.jpg'),
      category: 'À la carte',
      course: 'starter',
      dietary: ['Vegetarian'],
      allergens: ['Dairy']
    ...
    { 
      ...
      price: 165.00,
      image: require('../assets/Prawn Cocktail.jpg'),
      category: 'À la carte',
      course: 'starter',
    ...
    { 
      ...
      price: 485.00,
      image: require('../assets/Seared Scallops with Citrus-Shallot Salad.webp'),
      category: 'À la carte',
      course: 'main',
      dietary: ['Gluten-free', 'Dairy-free'],
      allergens: ['Shellfish']
    ...
    { 
      ...
      price: 725.00,
      image: require('../assets/Grilled Ribeye Steak.jpg'),
      category: 'À la carte',
      course: 'main',
      dietary: ['Gluten-free'],
      allergens: ['Dairy']
    ...
    { 
      ...
      price: 395.00,
      image: require('../assets/Wild Mushroom Risotto.webp'),
      category: 'À la carte',
      course: 'main',
      dietary: ['Vegetarian'],
    ...
    { 
      ...
      price: 545.00,
      image: require('../assets/Pan-Seared Salmon.webp'),
      category: 'À la carte',
      course: 'main',
      dietary: ['Gluten-free'],
    ...
    { 
      ...
      price: 145.00,
      image: require('../assets/Chocolate Lava Cake.webp'),
      category: 'À la carte',
      course: 'dessert',
      dietary: ['Vegetarian'],
    ...
    { 
      ...
      price: 125.00,
      image: require('../assets/Creme Brulee.webp'),
      category: 'À la carte',
      course: 'dessert',
      dietary: ['Vegetarian', 'Gluten-free'],
    ...
    { 
      ...
      price: 135.00,
      image: require('../assets/Tiramisu.webp'),
      category: 'À la carte',
      course: 'dessert',
      dietary: ['Vegetarian'],
      allergens: ['Dairy', 'Gluten', 'Eggs']
    ...
    { 
      ...
      price: 95.00,
      image: require('../assets/Fresh Berry Sorbet.webp'),
      category: 'À la carte',
      course: 'dessert',
